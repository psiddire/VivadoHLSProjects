...
#ifndef __BitShift_mul_mul_bkb__HH__
#define __BitShift_mul_mul_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(BitShift_mul_mul_bkb) {
    ...
    SC_CTOR(BitShift_mul_mul_bkb):  ACMP_smul_us_U ("ACMP_smul_us_U") {
