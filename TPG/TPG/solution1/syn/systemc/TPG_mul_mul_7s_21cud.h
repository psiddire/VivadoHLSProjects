...
#ifndef __TPG_mul_mul_7s_21cud__HH__
#define __TPG_mul_mul_7s_21cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(TPG_mul_mul_7s_21cud) {
    ...
    SC_CTOR(TPG_mul_mul_7s_21cud):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
