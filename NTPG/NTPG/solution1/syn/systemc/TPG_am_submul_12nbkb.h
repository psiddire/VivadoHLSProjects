...
#ifndef __TPG_am_submul_12nbkb__HH__
#define __TPG_am_submul_12nbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(TPG_am_submul_12nbkb) {
    ...
    SC_CTOR(TPG_am_submul_12nbkb):  simcore_am_0_U ("simcore_am_0_U") {
