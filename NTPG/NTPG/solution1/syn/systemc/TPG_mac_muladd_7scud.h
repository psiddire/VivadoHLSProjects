...
#ifndef __TPG_mac_muladd_7scud__HH__
#define __TPG_mac_muladd_7scud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(TPG_mac_muladd_7scud) {
    ...
    SC_CTOR(TPG_mac_muladd_7scud):  simcore_mac_0_U ("simcore_mac_0_U") {
