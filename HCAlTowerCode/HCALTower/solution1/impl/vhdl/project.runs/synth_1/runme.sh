...
HD_PWD='/afs/cern.ch/user/p/psiddire/CMSSW_10_2_2/src/VivadoHLSProjects/HCAlTowerCode/HCALTower/solution1/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TowerPeaks.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TowerPeaks.tcl
