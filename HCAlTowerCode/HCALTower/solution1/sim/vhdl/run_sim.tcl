...
if {[file isfile TowerPeaks.autotvin.dat]} {
	file delete -force TowerPeaks.autotvin.dat
}

if {[file isfile TowerPeaks.autotvout.dat]} {
	file delete -force TowerPeaks.autotvout.dat
}
