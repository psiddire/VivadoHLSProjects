...
$(ObjDir)/testHCALTower.cpp_pre.cpp.tb.o : testHCALTower.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling testHCALTower.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/HCALTower.cpp_pre.cpp.tb.o : HCALTower.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling HCALTower.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
