...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "TowerPeaks.autotvin.dat"
	set constFileTvOut       "TowerPeaks.autotvout.dat"
	set constFileHdlTvIn     "TowerPeaks.autohdltvin.dat"
	set constFileHdlTvOut    "TowerPeaks.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
