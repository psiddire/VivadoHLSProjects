...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "MakeHT.autotvin.dat"
	set constFileTvOut       "MakeHT.autotvout.dat"
	set constFileHdlTvIn     "MakeHT.autohdltvin.dat"
	set constFileHdlTvOut    "MakeHT.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
