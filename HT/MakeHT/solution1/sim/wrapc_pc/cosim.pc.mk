...
$(ObjDir)/TestMakeHT.cpp_pre.cpp.tb.o : TestMakeHT.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling TestMakeHT.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/MakeHT.cc_pre.cc.tb.o : MakeHT.cc_pre.cc.tb.cc $(ObjDir)/.dir
	$(Echo) "   Compiling MakeHT.cc_pre.cc.tb.cc" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
