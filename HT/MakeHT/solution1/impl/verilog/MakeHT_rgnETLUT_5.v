...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module MakeHT_rgnETLUT_5_rom (
...
initial begin
    $readmemh("./MakeHT_rgnETLUT_5_rom.dat", ram0);
    $readmemh("./MakeHT_rgnETLUT_5_rom.dat", ram1);
end
...
MakeHT_rgnETLUT_5_rom MakeHT_rgnETLUT_5_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
