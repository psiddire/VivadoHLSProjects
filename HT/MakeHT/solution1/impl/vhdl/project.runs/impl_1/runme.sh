...
HD_PWD='/afs/cern.ch/user/p/psiddire/CMSSW_10_2_2/src/VivadoHLSProjects/HT/MakeHT/solution1/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MakeHT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MakeHT.tcl -notrace
