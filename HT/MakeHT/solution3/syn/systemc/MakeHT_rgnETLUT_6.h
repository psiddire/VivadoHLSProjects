...
#ifndef __MakeHT_rgnETLUT_6_H__
#define __MakeHT_rgnETLUT_6_H__
...
struct MakeHT_rgnETLUT_6_ram : public sc_core::sc_module {
...
MakeHT_rgnETLUT_6_ram* meminst;


SC_CTOR(MakeHT_rgnETLUT_6) {
meminst = new MakeHT_rgnETLUT_6_ram("MakeHT_rgnETLUT_6_ram");
