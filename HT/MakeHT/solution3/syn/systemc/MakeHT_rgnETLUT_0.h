...
#ifndef __MakeHT_rgnETLUT_0_H__
#define __MakeHT_rgnETLUT_0_H__
...
struct MakeHT_rgnETLUT_0_ram : public sc_core::sc_module {
...
MakeHT_rgnETLUT_0_ram* meminst;


SC_CTOR(MakeHT_rgnETLUT_0) {
meminst = new MakeHT_rgnETLUT_0_ram("MakeHT_rgnETLUT_0_ram");
